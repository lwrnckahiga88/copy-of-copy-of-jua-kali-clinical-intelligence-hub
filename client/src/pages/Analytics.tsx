/**
 * Analytics — renders pandemicseird1.html from health-ai repo
 * Auth-free: accessible without OAuth
 */
import { useState } from "react";

const SRC = "https://raw.githubusercontent.com/lwrnckahiga88/health-ai/main/public/pandemicseird1.html";
    ...
    <div className="flex flex-col" style={{minHeight:"100%", background:"#0f172a"}}>
      ...
      <div className="flex items-center justify-between px-4 py-2 bg-slate-900 border-b border-slate-800 flex-shrink-0">
        <div>
          ...
          <span className="text-slate-500 text-xs ml-2">health-ai · pandemicseird1.html</span>
        </div>
