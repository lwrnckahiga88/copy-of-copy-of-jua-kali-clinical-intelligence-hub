/**
 * Triad Neuro — renders v12.html
 * Newton Guardian PWA
 */
import { useState } from "react";

const SRC = "/agents/v12.html";
    ...
    <div className="flex flex-col" style={{ minHeight: "100%", background: "#0f172a" }}>
      ...
      <div className="flex items-center justify-between px-4 py-2 bg-slate-900 border-b border-slate-800 flex-shrink-0">
        <div className="min-w-0">
          <span className="font-semibold text-cyan-400 text-sm">Triad Neuro</span>
          <span className="text-slate-500 text-xs ml-2 hidden sm:inline">Newton Guardian PWA</span>
        </div>
      ...
      {error ? (
        <div className="flex-1 flex flex-col items-center justify-center gap-4 bg-slate-950 p-8">
          ...
          <p className="text-slate-400 text-sm text-center">Full hybrid genomics + multi-treatment neural analysis platform</p>
          <a
            href={SRC}
            target="_blank"
            rel="noopener noreferrer"
